	...
	public function ays_generate_popup( $attr ){
        ...
        /*******************************************************************************************************/
			...
			$popupbox_view = $ays_pb_custom_css."
					<div class='ays-pb-modals av_pop_modals_".$id." " . $close_popup_esc_class . "' style='min-width: 100%;'>
            ...
            $popupbox_view .= "<div id='ays-pb-screen-shade_".$id."' overlay='overlay_".$id."' data-mobile-overlay='".$enable_overlay_text_mobile."'></div>
