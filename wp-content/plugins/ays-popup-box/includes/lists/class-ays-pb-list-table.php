...
class Ays_PopupBox_List_Table extends WP_List_Table {
    ...
    public function add_or_edit_popupbox($data){
        ...
        //Border Size Mobile
        $bordersize_mobile = ( isset($data['ays_pb_bordersize_mobile']) && $data['ays_pb_bordersize_mobile'] != '' ) ? wp_unslash(sanitize_text_field(intval(round( $data['ays_pb_bordersize_mobile'] )))) : 1;
        ...
        $border_radius_mobile = ( isset($data['ays_pb_border_radius_mobile']) && $data['ays_pb_border_radius_mobile'] != '' ) ? wp_unslash( sanitize_text_field(intval(round( $data['ays_pb_border_radius_mobile'] )))) : 4;
