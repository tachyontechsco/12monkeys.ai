...
$options = array(
    ...
    'use_close_button_icons' => 'on',
    'close_button_icon' => 'default',
    'enable_pb_sound' => 'off',
    'overlay_color' => '#000',
...
// Open Delay Mobile
$open_delay_mobile =  (isset($options['open_delay_mobile']) && $options['open_delay_mobile'] != '') ? esc_attr( abs(intval($options['open_delay_mobile'])) ) : 0;
...
$autoclose          = (isset($popupbox['autoclose']) && $popupbox['autoclose'] != "") ? esc_attr( abs($popupbox['autoclose']) ) : "";
    ...
    <div class="container-fluid">
        <form method="post" name="popup_attributes" id="ays_pb_form">
                ...
                <div class="ays-pb-subtitle-main-box">
                    <p class="ays_pb_subtitle">
                        <?php if(isset($id) && count($get_all_popups) > 1):?>
                            <!-- <span class="ays-subtitle-inner-popups-page ays-pb-open-popups-list"> -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label class="ays-pb-label-style" for="<?php echo $this->plugin_name; ?>-show_all_yes"><?php echo __("All pages", "ays-popup-box"); ?>
                            <input type="radio" id="<?php echo $this->plugin_name; ?>-show_all_yes"  name="<?php echo $this->plugin_name; ?>[show_all]" value="all" <?php if($show_all == 'yes' || $show_all == 'all'){ echo 'checked';} else { echo '';} ?> />
                        </label>
                        <label class="ays-pb-label-style" for="<?php echo $this->plugin_name; ?>-show_all_except"><?php echo __("Except", "ays-popup-box"); ?>
                            <input type="radio" id="<?php echo $this->plugin_name; ?>-show_all_except"  name="<?php echo $this->plugin_name; ?>[show_all]" value="except" <?php if($show_all == 'except'){ echo 'checked';} else { echo '';} ?>/>
                        </label>
                        <label class="ays-pb-label-style" for="<?php echo $this->plugin_name; ?>-show_all_selected"><?php echo __("Include", "ays-popup-box"); ?>
                            <input type="radio" id="<?php echo $this->plugin_name; ?>-show_all_selected"  name="<?php echo $this->plugin_name; ?>[show_all]" value="selected" <?php if($show_all == 'selected' || $show_all == 'no'){ echo 'checked';} else { echo '';} ?>/>
                        </label>
            ...
            <div id="tab2" class="ays-pb-tab-content  <?php echo ($ays_pb_tab == 'tab2') ? 'ays-pb-tab-content-active' : ''; ?>">
                    ...
                    <div class="col-sm-9">
                        <div class="ays_pb_pc_and_mobile_container ays_pb_pc_and_mobile_container_cb">
                            ...
                            <div class="ays_pb_option_for_mobile_device ays_pb_option_for_mobile_device_cb ays_divider_left <?php echo ($close_popup_overlay_mobile || $close_popup_overlay != 'off') ? 'show' : '' ?>">
                                ...
                                <p class="onoffswitch" style="margin:0;">
                                    <input type="checkbox" name="close_popup_overlay_mobile" class="ays-pb-onoffswitch-checkbox" id="ays_close_popup_overlay_mobile" <?php if($close_popup_overlay_mobile){ echo 'checked';} ?>/>
                                </p>
                            </div>
                        </div>
                        <div class="ays-pb-youtube-video-link">
                ...
                <hr class="<?php echo $close_button == 'off' ? '' : 'display_none' ;?>">
                <!-- Show close button by hovering over the popup start -->
                <div class="form-group row <?php echo $close_button == 'off' ? '' : 'display_none';?>" id="ays_pb_close_hover">
                    <div class="col-sm-3">
                ...
                <div class="form-group row" id="ays_pb_close_autoclose">
                    <div class="col-sm-3">
                ...
                <hr class="ays-pb-hide-timer-hr <?php echo $ays_pb_show_hide_timer_box ? '' : 'display_none'; ?>">
                <!-- hide timer -->
                <div class="form-group row" id="ays_pb_hide_timer_popup" style="<?php echo $ays_pb_show_hide_timer_box ? '' : 'display:none;'; ?>">
                    <div class="col-sm-3">
                ...
                <div class="col-sm-12 ays-pro-features-v2-main-box">
                    <div class="ays-pro-features-v2-small-buttons-box">
                        <div>
                            <a href="https://youtu.be/oOvHTcePpys?list=PL4ufu1uAjjWQTYn0O_72TLzmqgmVIYKI2" target="_blank" class="ays-pro-features-v2-video-button">
                                <div class="ays-pro-features-v2-video-icon" style="background-image: url('<?php echo esc_attr(AYS_PB_ADMIN_URL); ?>/images/icons/pro-features-icons/Video_24x24.svg');" data-img-src="<?php echo esc_attr(AYS_PB_ADMIN_URL); ?>/images/icons/pro-features-icons/Video_24x24.svg')"></div>
                                <div class="ays-pro-features-v2-video-text">
                                    <?php echo __("View demo" , "ays-popup-box"); ?>
                                </div>
                            </a>
                        </div>
                ...
                <div class="col-sm-12 ays-pro-features-v2-main-box">
                    <div class="ays-pro-features-v2-small-buttons-box">
                        <div>
                            <a href="https://youtu.be/yh8U4j7HsLE?list=PL4ufu1uAjjWQTYn0O_72TLzmqgmVIYKI2" target="_blank" class="ays-pro-features-v2-video-button">
                                <div class="ays-pro-features-v2-video-icon" style="background-image: url('<?php echo esc_attr(AYS_PB_ADMIN_URL); ?>/images/icons/pro-features-icons/Video_24x24.svg');" data-img-src="<?php echo esc_attr(AYS_PB_ADMIN_URL); ?>/images/icons/pro-features-icons/Video_24x24.svg')"></div>
                                <div class="ays-pro-features-v2-video-text">
                                    <?php echo __("View demo" , "ays-popup-box"); ?>
                                </div>
                ...
                <div class="col-sm-12 ays-pro-features-v2-main-box">
                    <div class="ays-pro-features-v2-small-buttons-box">
                        <div>
                            <a href="https://youtu.be/Puecfcp7JEs?list=PL4ufu1uAjjWQTYn0O_72TLzmqgmVIYKI2" target="_blank" class="ays-pro-features-v2-video-button">
                                <div class="ays-pro-features-v2-video-icon" style="background-image: url('<?php echo esc_attr(AYS_PB_ADMIN_URL); ?>/images/icons/pro-features-icons/Video_24x24.svg');" data-img-src="<?php echo esc_attr(AYS_PB_ADMIN_URL); ?>/images/icons/pro-features-icons/Video_24x24.svg')"></div>
                                <div class="ays-pro-features-v2-video-text">
                                    <?php echo __("View demo" , "ays-popup-box"); ?>
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 ays_divider_left ays-pb-height-content">
                        ...
                        <div class="col-sm-12 ays-pro-features-v2-main-box">
                            <div class="ays-pro-features-v2-big-buttons-box-main-container">
                                <div class="ays-pro-features-v2-big-buttons-box-view-demo">
                                    <a href="https://youtu.be/R-KO73oxWqY?list=PL4ufu1uAjjWQTYn0O_72TLzmqgmVIYKI2" target="_blank" class="ays-pro-features-v2-upgrade-button ays-pro-features-v2-upgrade-button-view-demo">
                                        <div class="ays-pro-features-v2-upgrade-text">
                            ...
                            <div class="ays-pro-features-v2-small-buttons-box">
                                <div>
                                    <a href="https://youtu.be/R-KO73oxWqY?list=PL4ufu1uAjjWQTYn0O_72TLzmqgmVIYKI2" target="_blank" class="ays-pro-features-v2-video-button">
                                        <div class="ays-pro-features-v2-video-icon" style="background-image: url('<?php echo esc_attr(AYS_PB_ADMIN_URL); ?>/images/icons/pro-features-icons/Video_24x24.svg');" data-img-src="<?php echo esc_attr(AYS_PB_ADMIN_URL); ?>/images/icons/pro-features-icons/Video_24x24.svg')"></div>
                                        <div class="ays-pro-features-v2-video-text">
                                            <?php echo __("View demo" , "ays-popup-box"); ?>
                                        </div>
                        ...
                        <hr>
                        <div class="form-group row" id="ays-popup-box-background-image-container">
                            <div class="col-sm-4">
                                ...
                                <div class="ays_toggle_parent">
                                    ...
                                    <div class="ays_toggle_target ays_pb_bg_image_mobile_container" style=" <?php echo ( $enable_bg_image_mobile ) ? '' : 'display:none'; ?>">
                                        ...
                                        <div style="<?php echo $style_bg_mobile; ?>">
                                            <div class="ays-pb-bg-image-container-mobile">
                                                <span class="ays-remove-bg-img-mobile"></span>
                        ...
                        <hr>
                        <div class="form-group row" id="ays-popup-box-background-image-position-container">
                            <div class="col-sm-4">
                        ...
                        <hr>
                        <div class="form-group row" id="ays-popup-box-background-image-sizing-container">
                            <div class="col-sm-4">
                        ...
                        <!-- TP Changes  -->
                        <!--  -->
                        <div class="form-group row" id="ays-popup-box-background-gradient-container">
                            <div class="col-sm-4">
                        ...
                        <hr/>
                        <!--  -->
                        <div class="form-group row" id="ays-popup-box-header-background-color-container">
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row" id="ays-popup-box-close-button-image-container">
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-8 ays_divider_left">
                                ...
                                <div class="col-sm-8 ays_pb_close_btn_bg_img_container" style="<?php echo $close_btn_style_bg; ?>">
                            ...
                            <div class='ays-pb-modals'>
                                ...
                                <div class='ays-pb-live-container ays_window ays_bg_image_box'>
                                    <div class='ays_topBar'>
                                        <label class='ays-pb-modal-close ays_close ays-close-button-on-off' style='<?php echo $hide_close_btn; ?>'><img src="<?php echo AYS_PB_ADMIN_URL . "/images/icons/times-2x.svg"?>"></label>
                                        <a class='ays_hide'></a>
        ...
        (function ($) {
            $(document).ready(function () {
                ...
                switch ($("input[name='<?php echo $this->plugin_name; ?>[view_type]']:checked").val()) {
                    ...
                    case 'video':
                        if(modal_content == 'video_type'){
                            ...
                            $(document).find('#ays-popup-box-background-image-container').hide();
                            $(document).find('#ays-popup-box-background-image-container').prev('hr').hide();
                            $(document).find('#ays-popup-box-background-image-position-container').hide();
                            $(document).find('#ays-popup-box-background-image-position-container').prev('hr').hide();
                            $(document).find('#ays-popup-box-background-image-sizing-container').hide();
                            $(document).find('#ays-popup-box-background-image-sizing-container').prev('hr').hide();
                            $(document).find('#ays-popup-box-background-gradient-container').hide();
                            $(document).find('#ays-popup-box-background-gradient-container').prev('hr').hide();
                            $(document).find('#ays-popup-box-header-background-color-container').hide();
                            $(document).find('#ays-popup-box-header-background-color-container').prev('hr').hide();
                ...
                $(document).find("#<?php echo $this->plugin_name; ?>-ays_pb_bordersize").on('change', function () {
                    ...
                    let tb,tb_value,rl,rl_value,auto_1,auto_2,res;
                    $(ays_pb_view_type).css('border', $("#<?php echo $this->plugin_name; ?>-ays_pb_bordersize").val() + "px "+$('#ays_pb_border_style').val()+ $("#<?php echo $this->plugin_name; ?>-bordercolor").val());
