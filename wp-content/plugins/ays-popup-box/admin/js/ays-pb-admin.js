(function( $ ) {
    ...
    $(document).ready(function (){
        ...
        $('.popup-box-upgrade-to-pro').hover(
			function() {
				$(this).css({
				...
				$(this).find('.popup-box-upgrade-green-icon').css('display', 'none');
				$(this).find('.popup-box-upgrade-white-icon').css('display', 'inline-block');
			},
			function() {
				$(this).css({
				...
				$(this).find('.popup-box-upgrade-green-icon').css('display', 'inline-block');
				$(this).find('.popup-box-upgrade-white-icon').css('display', 'none');
			}
		);
        ...
        $(document).find('.ays_pb_layer_button').on('click',function(){
            ...
            switch ( checkedInp ) {
                    ...
                    case 'video_type':
                        $('#ays_custom_html').hide();
                        $('.ays_pb_themes').hide();
                        $('.ays_pb_content_padding_option').prev().hide();
                        $('.ays_pb_content_padding_option').hide();
                        $('.video_hr').hide();
                        ...
                        $(document).find(".ays_pb_autoclose_on_completion_container").show();
                        $('.ays_pb_autoclose_on_completion_container').before('<hr>');
        ...
        if($('.ays_pb_themes').hasClass('display_none_inp')) {
            $('.ays_pb_content_padding_option').prev().hide();
            $('.ays_pb_content_padding_option').hide();
        }
